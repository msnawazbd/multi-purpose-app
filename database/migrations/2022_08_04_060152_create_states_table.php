...
class CreateStatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('states', function (Blueprint $table) {
            $table->id();
            $table->foreignId('country_id')->nullable()->default(null)->constrained('countries')->onUpdate('cascade')->onDelete('cascade');
            $table->string('state_name', 80);
            $table->char('state_abbreviation', 80);
            $table->string('state_slug', 100);
