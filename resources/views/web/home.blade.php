<x-web-layout>
    ...
    <div class="home-banner margin-bottom-0"
         style="background:#f41b3b url({{ asset('web/') }}/img/banner-2.jpg) no-repeat;" data-overlay="5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-11 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <form class="main-search-wrap fl-wrap half-column">
                        ...
                        <div class="main-search-button">
                            <button class="btn full-width theme-bg text-white" type="button">Search<i
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-5.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        ...
                                                        <span class="cats-title">Beauty &amp; Makeup</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                                            <button type="button"><i
                                                                    class="lni lni-envelope position-absolute"></i>
                                                            </button>
                                                        </div>
                                                        <div class="Goodup-bookmark-btn">
                                                            <button type="button"><i
                                                                    class="lni lni-heart-filled position-absolute"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-6.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-2.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">The Sartaj
                                                        Blue Night</a></h4>
                                                <div class="Goodup-location"><i
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-3"><i class="lni lni-cake"></i></div>
                                                        <span class="cats-title">Night Party</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-7.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-3.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">Pizza
                                                        Delight Cafe Shop</a></h4>
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>102 Satirio,
                                                    Canada
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-4"><i class="lni lni-coffee-cup"></i>
                                                        </div>
                                                        <span class="cats-title">Coffee &amp; Bars</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-8.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-4.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">The Great
                                                        Allante Shop</a></h4>
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Oliy Denver, USA
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                                </div>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-5"><i
                                                                class="lni lni-shopping-basket"></i></div>
                                                        <span class="cats-title">Shopping Mall</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-9.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-5.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">Unisex Blue
                                                        Spa Massage</a></h4>
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Warmingham,
                                                    London
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-5"><i class="lni lni-surf-board"></i>
                                                        </div>
                                                        <span class="cats-title">Spa &amp; Salon</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-10.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-6.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">Washington,
                                                        Canada</a></h4>
                                                <div class="Goodup-location"><i
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-6"><i class="lni lni-burger"></i></div>
                                                        <span class="cats-title">Food Services</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-11.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-7.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">Ubber
                                                        Shopping Services</a></h4>
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Metrio General
                                                    Store
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-7"><i class="lni lni-car"></i></div>
                                                        <span class="cats-title">Tour &amp; Travels</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-2.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-1.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            src="{{ asset('web/') }}/img/t-8.png"
                                                            class="img-fluid circle" alt=""></a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-2.html"
                                                                                     class="text-dark fs-md">Rajwara
                                                        Marriage Home</a></h4>
                                                <div class="Goodup-location"><i
                                                        class="fas fa-map-marker-alt me-1 theme-cl"></i>Old California,
                                                    USA
                                                </div>
                                                <div class="Goodup-middle-caption mt-3">
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus</p>
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <a href="half-map-search-2.html" class="Goodup-cats-wrap">
                                                        <div class="cats-ico bg-8"><i class="lni lni-gift"></i></div>
                                                        <span class="cats-title">Wedding</span></a>
                                                </div>
                                                <div class="Goodup-ft-last">
                                                    <div class="Goodup-inline">
                                                        <div class="Goodup-bookmark-btn">
                                        ...
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Amagansett
                                                        Go Around</a></h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="event-detail.html" class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-2.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Amateur
                                                        Barber Night</a></h4>
                                                <div class="Goodup-location text-white"><i
                                                        class="fas fa-map-marker-alt me-1"></i>California, USA
                                                </div>
                                            </div>
                                        </div>
                                        <div class="Goodup-grid-fl-wrap">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="event-detail.html" class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-3.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Apex Muker
                                                        Trys</a></h4>
                                                <div class="Goodup-location text-white"><i
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="event-detail.html" class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/listing/l-4.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Ragni Book
                                                        Launching</a></h4>
                                                <div class="Goodup-location text-white"><i
                                                        class="fas fa-map-marker-alt me-1"></i>Old Denver, USA
                                                </div>
                                            </div>
                                        </div>
                                        <div class="Goodup-grid-fl-wrap">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Madhu Spa
                                                        Salon</a></h4>
                                                <div class="Goodup-location text-white"><i
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Blue Light
                                                        Cafe</a></h4>
                                                <div class="Goodup-location text-white"><i
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Allante
                                                        Mall Opening</a></h4>
                                                <div class="Goodup-location text-white"><i
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-overlay-caps">
                                                <h4 class="mb-0 ft-medium medium"><a href="event-detail.html"
                                                                                     class="text-white fs-md">Antisocial
                                                        Darwinism</a></h4>
                                                <div class="Goodup-location text-white"><i
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-1.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Heather D. Birch</a>
                                                </h4></div>
                                        ...
                                        <div class="doctor-grid-footer">
                                            <div class="doc-foot-first"><span class="av-status available">Available Today</span>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-2.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Joyce G. Howell</a></h4>
                                            </div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-3.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Juliana J. GGoodupry</a>
                                                </h4></div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-4.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Elizabeth J. Vergara</a>
                                                </h4></div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-5.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Michelle R. McIntyre</a>
                                                </h4></div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-6.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Mary F. Holliday</a>
                                                </h4></div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-7.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Dennis K. Bales</a></h4>
                                            </div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="doctor-grid-view">
                                        <div class="doctor-grid-thumb">
                                            <a href="single-listing-detail-4.html"><img
                                                    src="{{ asset('web/') }}/img/doc-8.jpg" class="img-fluid"
                                                    alt=""></a>
                                        </div>

                                        <div class="doctor-grid-caption">
                                            <div class="doc-title-wrap"><h4 class="doc-title verified"><a
                                                        href="single-listing-detail-4.html">Dr. Donald S. Herring</a>
                                                </h4></div>
                                            <span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
                                        ...
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-1.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-7.html"
                                                                                     class="text-dark fs-md">New Hyundai
                                                        Creta</a></h4>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-2.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-7.html"
                                                                                     class="text-dark fs-md">New Hyundai
                                                        Creta<span class="verified-badge"><i
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-3.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-4.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-5.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-6.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-7.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-7.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/car/c-8.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-1.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-prt-price">$<span>30,999</span></div>
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.8</span><a
                                                        href="search-property.html" class="cats-1">Apartment</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Liverpool
                                                        London, LC345AC<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                                            ...
                                                            <li><i class="fas fa-calendar"></i><span>3 Days Ago</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-2.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            ...
                                                            class="img-fluid circle" alt=""></a></div>
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.7</span><a
                                                        href="search-property.html" class="cats-1">Condos</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Montreal
                                                        Canada, HAQC445<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-3.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            ...
                                                            class="img-fluid circle" alt=""></a></div>
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.5</span><a
                                                        href="search-property.html" class="cats-1">Villa</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Huwai
                                                        Denever USA, AWE789O<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-4.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            ...
                                                            class="img-fluid circle" alt=""></a></div>
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.9</span><a
                                                        href="search-property.html" class="cats-1">House</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Alameda
                                                        Canada, SHQT45O<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-5.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            ...
                                                            class="img-fluid circle" alt=""></a></div>
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.6</span><a
                                                        href="search-property.html" class="cats-1">Building</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Henever
                                                        Canada, QWUI98<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                            ...
                                            <div class="Goodup-grid-footer py-2 px-3">
                                                <div class="Goodup-ft-first">
                                                    <div class="Goodup-location"><i
                                                            class="fas fa-map-marker-alt me-1 theme-cl"></i>Old Denver,
                                                        USA
                                                    </div>
                                                </div>
                                                <div class="Goodup-ft-last">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-6.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                <div class="Goodup-author"><a href="author-detail.html"><img
                                                            ...
                                                            class="img-fluid circle" alt=""></a></div>
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.2</span><a
                                                        href="search-property.html" class="cats-1">Apartment</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Barghimbar
                                                        USA, ERIO098<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-5.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/real/r-7.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                        ...
                                                        href="search-property.html" class="cats-1">Villa</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Burbank
                                                        Canada, ECH15462<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        ...
                                        <div class="Goodup-grid-fl-wrap">
                                            <div class="Goodup-caption px-3 py-2">
                                                ...
                                                <div class="Goodup-cates multi"><span class="Goodup-apr-rates"><i
                                                            class="fas fa-star"></i>4.7</span><a
                                                        href="search-property.html" class="cats-1">Work Space</a></div>
                                                <h4 class="mb-0 ft-medium medium"><a href="single-listing-detail-5.html"
                                                                                     class="text-dark fs-md">Emeryville
                                                        Green Vally<span class="verified-badge"><i
                                                                class="fas fa-check-circle"></i></span></a></h4>
                                                <div class="Goodup-middle-caption mt-2">
                                                    <div class="Goodup-options-list">
                                                        <ul class="no-list-style">
                                        ...
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/1.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/2.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/3.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/4.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/5.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/6.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/7.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                    ...
                                    <div class="Goodup-grid-wrap">
                                        <div class="Goodup-grid-upper">
                                            ...
                                            <div class="Goodup-grid-thumb">
                                                <a href="single-listing-detail-8.html"
                                                   class="d-block text-center m-auto"><img
                                                        src="{{ asset('web/') }}/img/rooms/8.jpg" class="img-fluid"
                                                        alt=""></a>
                                            </div>
                                            <div class="Goodup-rating overlay">
                                                <div class="Goodup-pr-average high">4.2</div>
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-1.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-2.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-3.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-4.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-5.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-6.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                                <h4 class="_jb_title"><a href="single-listing-detail-6.html">SEO
                                                        Expert</a></h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-7.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-8.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-9.png" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-10.png" class="img-fluid"
                                                         alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                    <div class="_jb_list72">
                                        ...
                                        <div class="_jb_list72_flex">
                                            <div class="_jb_list72_first">
                                                <div class="_jb_list72_yhumb">
                                                    <img src="{{ asset('web/') }}/img/c-11.png" class="img-fluid"
                                                         alt="">
                                                </div>
                                            </div>
                                            <div class="_jb_list72_last">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-7 col-md-9 col-sm-12">
                    <div class="sec_title position-relative text-center mb-5">
                        ...
                        <h2 class="ft-bold">We Have Worked with <span class="theme-cl">10,000+</span> Trusted Companies
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-1.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-2.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-3.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-4.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-5.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-6.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-7.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-8.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-9.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>

                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="empl-thumb text-center px-3 py-4">
                        <img src="{{ asset('web/') }}/img/l-10.png" class="img-fluid mx-auto" alt=""/>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="gup_blg_grid_box">
                        <div class="gup_blg_grid_thumb">
                            <a href="blog-detail.html"><img src="{{ asset('web/') }}/img/b-4.jpg" class="img-fluid"
                                                            alt=""></a>
                        </div>
                        <div class="gup_blg_grid_caption">
                            <div class="blg_tag"><span>Marketing</span></div>
                            <div class="blg_title"><h4><a href="blog-detail.html">What Is a VPN and How Does It
                                        Work?</a></h4></div>
                            <div class="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                    blanditiis praesentium voluptatum</p></div>
                        </div>
                                ...
                                <div class="crs_fl_first">
                                    <div class="crs_tutor">
                                        <div class="crs_tutor_thumb"><a href="javascript:void(0);"><img
                                                    src="{{ asset('web/') }}/img/team-2.jpg" class="img-fluid circle"
                                                    width="35" alt=""></a></div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="gup_blg_grid_box">
                        <div class="gup_blg_grid_thumb">
                            <a href="blog-detail.html"><img src="{{ asset('web/') }}/img/b-5.jpg" class="img-fluid"
                                                            alt=""></a>
                        </div>
                        <div class="gup_blg_grid_caption">
                            <div class="blg_tag"><span>Business</span></div>
                            <div class="blg_title"><h4><a href="blog-detail.html">What Is Ransomware: The Ultimate
                                        Guide?</a></h4></div>
                            <div class="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                    blanditiis praesentium voluptatum</p></div>
                        </div>
                        <div class="crs_grid_foot">
                            <div class="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
                                <div class="crs_fl_first">
                                    <div class="crs_tutor">
                                        <div class="crs_tutor_thumb"><a href="javascript:void(0);"><img
                                                    src="{{ asset('web/') }}/img/team-3.jpg" class="img-fluid circle"
                                                    width="35" alt=""></a></div>
                                    </div>
                                </div>
                                <div class="crs_fl_last">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="gup_blg_grid_box">
                        <div class="gup_blg_grid_thumb">
                            <a href="blog-detail.html"><img src="{{ asset('web/') }}/img/b-6.jpg" class="img-fluid"
                                                            alt=""></a>
                        </div>
                        <div class="gup_blg_grid_caption">
                            <div class="blg_tag"><span>Accounting</span></div>
                            <div class="blg_title"><h4><a href="blog-detail.html">Can iPads Get Viruses? What You
                                        Need</a></h4></div>
                            <div class="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                    blanditiis praesentium voluptatum</p></div>
                        </div>
                        <div class="crs_grid_foot">
                            <div class="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
                                <div class="crs_fl_first">
                                    <div class="crs_tutor">
                                        <div class="crs_tutor_thumb"><a href="javascript:void(0);"><img
                                                    src="{{ asset('web/') }}/img/team-5.jpg" class="img-fluid circle"
                                                    width="35" alt=""></a></div>
                                    </div>
                                </div>
                                <div class="crs_fl_last">
            ...
            <div class="row">
                    ...
                    <div class="Goodup-price-wrap">
                        <div class="Goodup-author-header">
                            <div class="Goodup-price-currency">
                                <h3><span class="Goodup-new-price">$<del>49</del></span><span class="Goodup-old-price">$<del>149</del></span>
                                </h3>
                            </div>
                            <div class="Goodup-price-title">
                                <div class="Goodup-price-tlt"><h4>Personal</h4></div>
                                <div class="Goodup-price-ribbon"><span class="Goodup-ribbon-offer all">50% Off</span>
                                </div>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="Goodup-price-wrap">
                        <div class="Goodup-author-header">
                            ...
                            <div class="Goodup-price-title">
                                <div class="Goodup-price-tlt"><h4>Platinum</h4></div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="Goodup-price-wrap">
                        <div class="Goodup-author-header">
                            <div class="Goodup-price-currency">
                                <h3><span class="Goodup-new-price">$<del>149</del></span><span class="Goodup-old-price">$<del>249</del></span>
                                </h3>
                            </div>
                            <div class="Goodup-price-title">
                                <div class="Goodup-price-tlt"><h4>Standard</h4></div>
                                <div class="Goodup-price-ribbon"><span class="Goodup-ribbon-offer all">50% Off</span>
                                </div>
                            </div>
                            <div class="Goodup-price-subtitle">Best Choice for Individuals</div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                        ...
                        <div class="content-box">
                            ...
                            <div class="btn-box clearfix mt-5">
                                <a href="index.html" class="download-btn play-store me-1 d-inline-flex"><img
                                        src="{{ asset('web/') }}/img/ios.png" width="200" alt=""/></a>
                                <a href="index.html" class="download-btn play-store ms-2 mb-1 d-inline-flex"><img
                                        src="{{ asset('web/') }}/img/and.png" width="200" alt=""/></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
                        <figure class="image"><img src="{{ asset('web/') }}/img/app.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                </div>
            </div>
    ...
    <!-- ======================= Newsletter Start ============================ -->
    <section class="space bg-cover" style="background:#03343b url({{ asset('web/') }}/img/landing-bg.png) no-repeat;">
                    ...
                    <form class="bg-white rounded p-1">
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-4">
                                <div class="form-group mb-0 position-relative">
                                    <button class="btn full-width btn-height theme-bg text-light fs-md" type="button">
                                        Subscribe
                                    </button>
                                </div>
                            </div>
