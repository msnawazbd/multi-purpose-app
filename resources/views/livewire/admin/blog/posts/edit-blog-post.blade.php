                    ...
                    <div class="card">
                        ...
                        <form wire:submit.prevent="update" autocomplete="off">
                            <div class="card-body table-responsive">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label for="blog_category_id">Post Category <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div wire:ignore class="form-group">
                                            ...
                                            <textarea id="details" data-details="@this" wire:model.defer="state.details"
                                                      class="form-control @error('details') is-invalid @enderror">{!! $state['post_details'] !!}</textarea>
                                            @error('details')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="card-footer">
                                <x-inputs.button id="create-appointment" class="text-white">Update Post
                                </x-inputs.button>
                            </div>
                        </form>
                    </div>
